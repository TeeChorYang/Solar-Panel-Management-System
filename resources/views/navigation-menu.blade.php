        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->type === 'supplier')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('product-status') }}" :active="request()->routeIs('product-status')">
                            {{ __('Application Status Management') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('manager-order-status') }}" :active="request()->routeIs('manager-order-status')">
                ...
                @if (Auth::user()->type === 'manager')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('list-installations') }}" :active="request()->routeIs('list-installations')">
                            {{ __('Installations') }}
                        </x-nav-link>
                    </div>

                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('list-maintenances') }}" :active="request()->routeIs('list-maintenances')">
                            {{ __('Maintenances') }}
                        </x-nav-link>
                    </div>
                @endif
